"""
Inferecnce script for VQ-VAE for LDM
"""
import argparse
import glob
import os
...
from dataset_mnist import CelebDataset, MnistDataset
...
if __name__ == '__main__':
    ...
    configuration = os.path.join('conf', args.data + '.yaml')
    infer(conf = configuration)