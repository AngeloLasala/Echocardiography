"""
Main file to train the PLAX regression model with Generated data augumentation. The code provides flags for hyperparameters tuning and directory path where load the data 
...
if __name__ == '__main__':
    ...
    ## merge the dataset
    train_set = torch.utils.data.ConcatDataset([train_real_set, train_gen_set])
